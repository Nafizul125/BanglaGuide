...
# Default: PostgreSQL (production style). For quick local setup without Postgres,
# set environment variable USE_SQLITE=1 before running migrations.
if os.getenv("USE_SQLITE", "0") == "1":
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'BanglaGuide'),
...
WEATHER_API_KEY = os.getenv('WEATHER_API_KEY', 'e4b6f660c010a74239e58065694bd450')
CHANNEL_LAYERS = {
    "default": {
